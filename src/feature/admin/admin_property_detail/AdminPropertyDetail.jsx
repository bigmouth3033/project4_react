    ...
    <Container>
      <Left>
        <PropertyTitleStyled>
          ...
          <div>
            <div>
              ...
              <p>Instant book {getListingById.data.data.bookingType == "instant" ? "on" : "off"}</p>
            </div>
        ...
        <div>
          ...
          {viewType && (
            <>
              {[
                propertyOptions.find((item) => item.value == getListingById.data.data.propertyType),
              ].map((item, index) => {
                return (
        ...
        <div>
          <ViewMoreStyled onClick={() => setViewCategory((prev) => !prev)}>
            View category type {viewCategory ? <HiMiniArrowSmallDown /> : <HiMiniArrowSmallRight />}{" "}
          </ViewMoreStyled>
          {viewCategory && (
            <ItemStyled>
        ...
        <div>
          <ViewMoreStyled onClick={() => setAbout((prev) => !prev)}>
            View property description {about ? <HiMiniArrowSmallDown /> : <HiMiniArrowSmallRight />}{" "}
          </ViewMoreStyled>
          {about && (
            <ItemStyled>
        ...
        <div>
          <ViewMoreStyled onClick={() => setAmenity((prev) => !prev)}>
            View property amenities {amenity ? <HiMiniArrowSmallDown /> : <HiMiniArrowSmallRight />}{" "}
          </ViewMoreStyled>
          {amenity && (
            <ItemStyled>
              <h4>
        ...
        <div>
          ...
          {checkInType && (
            <ItemStyled>
              <h4>
                {!getListingById.data.data.selfCheckIn ? "Host-Managed Check-in" : "Self Check-in"}
              </h4>
              <p>
      ...
      <Right>
        <RightContainerStyled ref={rightRef}>
          ...
          <div>
            <button>View host detail</button>
            <button>View property booking</button>
            <button>Change property status</button>
          </div>
