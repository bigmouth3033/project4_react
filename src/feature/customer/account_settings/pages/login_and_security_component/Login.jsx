            ...
            <div className='title'>Login</div>
            {
                stage == 1 && (
                    <ConfirmPasswordContainer>
                        ...
                        <input type="password" className='password-input' value={currentPassword} onChange={e => setCurrentPassword(e.target.value)} />
                        <div style={{ color: 'rgb(0,132,137)', cursor: 'pointer' }}>Forget Password ?</div>

                        <div>New password</div>
                        <input type="password" className='password-input' value={newPassword} onChange={e => setNewPassword(e.target.value)} />
                        <div>Confirm password</div>
                        <input type="password" className='password-input' value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} />
                        <div style={{ color: 'red' }}>{errorMessage}</div>
                        <button className='update-password-button' onClick={putUpdatePassword}>Update Password</button>
                    </ConfirmPasswordContainer>
                )
            }
            {
                stage == 2 && (
                    <OtpContainer>
                        <div style={{ fontSize: '20px', fontWeight: 'bolder', marginTop: '3%', marginBottom: "2%" }}>Enter your verification code</div>
                        ...
                        <div className='buttons-options'>
                            <div onClick={e => setStage(1)} style={{cursor:'pointer'}} >Back</div>
