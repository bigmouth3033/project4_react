...
export default function PhoneNumberOption({ phoneNumber }) {
    ...
    const [descriptionAfter, setDescriptionAfter] = useState("Add a number so confirmed guests and Airbnb can get in touch. You can add other numbers and choose how they’re used.");
    ...
    return (
        <Container>
            <PersonalSettingOption title="Phone numbers" description={"Add a number so confirmed guests and Airbnb can get in touch. You can add other numbers and choose how they’re used."} edit={editAfter} isDisabled={false} onActionClick={setIsDisplay} />
            {isDisplay && (
                <FormGroup>
                            ...
                            <FormSelect value={dialCode} onChange={handleOptionChange}>
                                {
                                    phones?.map((phone, index) => (
                                        <FormOption key={index} value={phone.dial_code}>{phone.name} {phone.dial_code}</FormOption>
                                    )
                                    )
                                }
                            </FormSelect>
