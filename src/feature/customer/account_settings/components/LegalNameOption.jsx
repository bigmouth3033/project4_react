...
export default function LegalNameOption({ firstName, lastName }) {
    ...
    return (
        <Container>
            <PersonalSettingOption title="Legal name" description={descriptionAfter} edit={editAfter} isDisabled={false} onActionClick={setIsDisplay} />
            {isDisplay && (
                <FormGroup>
                    <FormControl>
                        <FormContainer>
                            <FormTitle>First name on ID</FormTitle>
                            <FormInput value={firstNameInput} onChange={(e) => handleFirstNameInput(e.target.value)}></FormInput>
                        </FormContainer>
                    ...
                    <FormControl>
                        <FormContainer>
                            ...
                            <FormInput value={lastNameInput} onChange={(e) => handleLastNameInput(e.target.value)}></FormInput>
                        </FormContainer>
